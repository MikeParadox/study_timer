...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_TimerWidget_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_TimerWidget_t qt_meta_stringdata_TimerWidget = {
    {
QT_MOC_LITERAL(0, 11) // "TimerWidget"
...
const QMetaObject TimerWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_TimerWidget.offsetsAndSize,
    qt_meta_data_TimerWidget,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_TimerWidget_t
, QtPrivate::TypeAndForceComplete<TimerWidget, std::true_type>
